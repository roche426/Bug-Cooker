...
<html>
    ...
    <body>
        ...
        <section class="container"><!--our restaurants-->
            ...
            <h2 class="text-center panel-body titre-section" id="location-h2">Trouver votre restaurant BugCookers</h2>
                        ...
                        <div class="col-thumbnail"><!--La loupe-->
                            <div class="thumbnail text-center restaurant-thumbnail">
                                <div class="caption">
                                    ...
                                    <a class="btn btn-green" href="" role="button">Nos specialités</a>
                                </div>
                            </div>
                        </div>
        ...
        <section><!--contact section-->
            <div class="container">
            <h2 class="text-center panel-body titre-section" id="form-h2">Une question, une suggestion ? Contactez-nous</h2>
            <div class="row">
                <div class="col-sm-4 col-sm-offset-4 col-xs-8 col-xs-offset-2">
                        <form method="post" name="formInformation">
                        <label for="name">Nom prénom :</label>
                        <input type="text" name="name"class="form-control form-element"/>
                        <label for="email">Email :</label>
                        <input type="email" name="email"class="form-control form-element"/>
                        <label for="phoneNumber">Numéro de téléphone :</label>
                        <input type="tel" name="phoneNumber"class="form-control form-element" />
                        <p id="p-contact">Votre message :</p>
                        <textarea class="form-control form-element" rows="3"></textarea>
                        <button class="btn btn-green form-element" id="send-button" name="send-button" type="submit">Envoyer</button>
                    </form>
                </div>
            </div>
          </div>
