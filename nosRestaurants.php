...
<html>
    ...
    <body>
        ...
        <section class="container"><!--our restaurants-->
            ...
            <h2 class="text-center" id="location-h2">Trouver votre restaurant BugCookers</h2>
                ...
                <div class="col-xs-12">
                    <div class="restaurant-location">
                        <div class="col-thumbnail"><!--La loupe-->
                            <div class="thumbnail text-center restaurent-thumbnail">
                                <div class="caption">
                                    <h3>La Loupe</h3>
        ...
        <section><!--contact section-->
            <div class="container">
            <h2 class="text-center" id="form-h2">Une question, une suggestion ? Contactez-nous</h2>
            <div class="row">
                <div class="col-sm-4 col-sm-offset-4 col-xs-8 col-xs-offset-2">
                        ...
                        <button class="btn btn-default form-element" id="send-button" name="send-button" type="submit">Envoyer</button>
                    </form>
                </div>
            </div>
          </div>
