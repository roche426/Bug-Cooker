                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="thumbnail specialite" id="spe-loupe">
                            ...
                            <div class="caption">
                                ...
                                <p class="text-center"><a href="/nosRestaurants.php#loupe" class="btn btn-primary" role="button">LA LOUPE</a></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="thumbnail specialite" id="spe-orleans">
                            ...
                            <div class="caption">
                                ...
                                <p class="text-center"><a href="nosRestaurants.php#orleans" class="btn btn-primary" role="button">ORLÉANS</a></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="thumbnail specialite" id="spe-bordeaux">
                            ...
                            <div class="caption">
                                ...
                                <p class="text-center"><a href="nosRestaurants.php#bordeaux" class="btn btn-primary" role="button">BORDEAUX</a></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="thumbnail specialite" id="spe-lyon">
                            ...
                            <div class="caption">
                                ...
                                <p class="text-center"><a href="nosRestaurants.php#lyon" class="btn btn-primary" role="button">LYON</a></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="thumbnail specialite" id="spe-toulouse">
                            ...
                            <div class="caption">
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
                                <p class="text-center"><a href="nosRestaurants.php#toulouse" class="btn btn-primary" role="button">TOULOUSE</a></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="thumbnail specialite" id="spe-lille">
                            ...
                            <div class="caption">
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
                                <p class="text-center"><a href="nosRestaurants.php#lille" class="btn btn-primary" role="button">LILLE</a></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="thumbnail specialite" id="spe-strasbourg">
                            ...
                            <div class="caption">
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
                                <p class="text-center"><a href="nosRestaurants.php#strasbourg" class="btn btn-primary" role="button">STRASBOURG</a></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="thumbnail specialite"  id="spe-paris">
                            ...
                            <div class="caption">
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
                                <p class="text-center"><a href="nosRestaurants.php#paris" class="btn btn-primary" role="button">PARIS</a></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-3 col-md-offset-3">
                        <div class="thumbnail specialite" id="spe-reims">
                            ...
                            <div class="caption">
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
                                <p class="text-center"><a href="nosRestaurants.php#reims" class="btn btn-primary" role="button">REIMS</a></p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-6 col-md-3">
                        <div class="thumbnail specialite" id="spe-biarritz">
                            ...
                            <div class="caption">
                                ...
                                <p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam.</p>
                                <p class="text-center"><a href="nosRestaurants.php#biarritz" class="btn btn-primary" role="button">BIARRITZ</a></p>
                            </div>
                        </div>
                    </div>
                </div>
